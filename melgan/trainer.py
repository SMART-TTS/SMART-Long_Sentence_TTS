...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str, required=False, default='config/default.yaml',
                        help="yaml file for configuration")
    parser.add_argument('-p', '--checkpoint_path', type=str, default='./chkpt/sw/sw_1225.pt',
                        help="path of checkpoint pt file to resume training")
    parser.add_argument('-n', '--name', type=str, required=False, default='sw',
